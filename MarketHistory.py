...
def main():
	...
	with open(r"C:\Users\Charles\source\repos\MarketHistory\MarketHistory\borax_history.json", "w+") as write_file:
		json.dump(b_data, write_file)
	
	#Write (new) transaction data to ongoing CSV file
	with open(r"C:\Users\Charles\source\repos\MarketHistory\MarketHistory\borax_history.csv", "w+", newline="") as f:
		with f:
	...
	#print(list, "\n")
	#print("Printing PPU value of first twenty entries in History Dict")
	#print(list["PricePerUnit"], "\n")
